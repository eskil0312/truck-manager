...
namespace TruckManager.Infrastructure.Migrations
{
    ...
    [Migration("20230414185013_Added_Users")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruckManager.Domain.CompanyAggregate.Company", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("TruckManager.Domain.UserAggregate.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TruckManager.Domain.CompanyAggregate.Company", b =>
                {
                    b.OwnsMany("TruckManager.Domain.TruckAggregate.ValueObjects.TruckId", "TruckIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                            ...
                            b1.ToTable("CompanyTruckIds", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("TruckId");
                        });

                    b.OwnsMany("TruckManager.Domain.UserAggregate.ValueObjects.UserId", "UserIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                            ...
                            b1.ToTable("CompanyUserIds", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("UserId");
                        });

                    b.Navigation("TruckIds");
